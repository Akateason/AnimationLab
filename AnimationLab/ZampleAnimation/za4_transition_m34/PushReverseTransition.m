...
@implementation PushReverseTransition
...
{
    //1
    ZA4SecViewController *fromVC = (ZA4SecViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ZA4ViewController *toVC = (ZA4ViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
